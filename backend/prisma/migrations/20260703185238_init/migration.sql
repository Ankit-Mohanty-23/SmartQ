...
CREATE TABLE "queues" (
    ...
    "doctorSpecialization" TEXT NOT NULL DEFAULT 'General Physician',
    "isExistingPatient" BOOLEAN NOT NULL DEFAULT false,
    "arrivedWithRecords" BOOLEAN NOT NULL DEFAULT false,
    "chronicConditionFlag" BOOLEAN NOT NULL DEFAULT false,
    "reasonForVisit" TEXT NOT NULL DEFAULT 'General Checkup',
    "numPriorVisits" INTEGER NOT NULL DEFAULT 0,
    "numComorbidities" INTEGER NOT NULL DEFAULT 0,
    "doctorExperienceYears" INTEGER NOT NULL DEFAULT 0,
    "doctorHistoricalAvgDuration" DOUBLE PRECISION NOT NULL DEFAULT 15.0,
    "patientsBefore" INTEGER NOT NULL DEFAULT 0,
    "facilityOccupancyRate" DOUBLE PRECISION NOT NULL DEFAULT 0.5,
